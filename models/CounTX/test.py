...
def get_args_parser():
    ...
    parser.add_argument(
        "--img_class_annotations",
        default="./data/FSC/FSC_147/ImageClasses_FSC147.txt",
        help="name of file with classes of images of FSC-147",
    )
...
class TestData(Dataset):
    def __init__(self, args):
        ...
        with open(args.img_class_annotations, 'r') as file:
            for line in file:
    ...
    def __getitem__(self, idx):
        ...
        #text = self.clip_tokenizer(self.img_classes[im_id]).squeeze(-2)
