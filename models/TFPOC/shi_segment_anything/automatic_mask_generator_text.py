...
class SamAutomaticMaskGenerator:
    ...
    def _generate_masks(self, image: np.ndarray,ref_bbox) -> MaskData:
        ...
        # check if points_per_side resulted in an infinite or NaN value
        if math.isinf(points_per_side) or math.isnan(points_per_side):
            points_per_side = self.points_per_side  # fallback to a default value
