...
parser.add_argument('--model', type=str, choices=['CounTX', 'CLIP-Count', 'TFPOC', 'VLCounter', 'DAVE', 'ZSC', 'PseCo', 'GroundingREC', "GroundingRECFSC", 'CountGD', "CountGDPlusPlus", 'FixedPointPromptCounting', 'all'], 
...
if args.model == 'all':
    model_names = ["CounTX", "CLIP-Count", "VLCounter", "DAVE", "ZSC", "GroundingREC", "GroundingRECFSC", "CountGD", "CountGDPlusPlus", "PseCo", "TFPOC", "FixedPointPromptCounting"] 
else:
